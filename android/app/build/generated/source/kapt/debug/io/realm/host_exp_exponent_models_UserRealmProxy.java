...
public class host_exp_exponent_models_UserRealmProxy extends host.exp.exponent.models.User
    implements RealmObjectProxy, host_exp_exponent_models_UserRealmProxyInterface {
    ...
    private ProxyState<host.exp.exponent.models.User> proxyState;

    host_exp_exponent_models_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<host.exp.exponent.models.User>(this);
    ...
    @SuppressWarnings("cast")
    public static host.exp.exponent.models.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        host.exp.exponent.models.User obj = realm.createObjectInternal(host.exp.exponent.models.User.class, true, excludeFields);

        final host_exp_exponent_models_UserRealmProxyInterface objProxy = (host_exp_exponent_models_UserRealmProxyInterface) obj;
        if (json.has("first")) {
    ...
    public static host.exp.exponent.models.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final host.exp.exponent.models.User obj = new host.exp.exponent.models.User();
        final host_exp_exponent_models_UserRealmProxyInterface objProxy = (host_exp_exponent_models_UserRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static host_exp_exponent_models_UserRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(host.exp.exponent.models.User.class), false, Collections.<String>emptyList());
        io.realm.host_exp_exponent_models_UserRealmProxy obj = new io.realm.host_exp_exponent_models_UserRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static host.exp.exponent.models.User copyOrUpdate(Realm realm, UserColumnInfo columnInfo, host.exp.exponent.models.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (host.exp.exponent.models.User) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static host.exp.exponent.models.User copy(Realm realm, UserColumnInfo columnInfo, host.exp.exponent.models.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (host.exp.exponent.models.User) cachedRealmObject;
        }

        host_exp_exponent_models_UserRealmProxyInterface realmObjectSource = (host_exp_exponent_models_UserRealmProxyInterface) newObject;

        Table table = realm.getTable(host.exp.exponent.models.User.class);
        ...
        io.realm.host_exp_exponent_models_UserRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, host.exp.exponent.models.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(host.exp.exponent.models.User.class);
        long tableNativePtr = table.getNativePtr();
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(host.exp.exponent.models.User.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$first = ((host_exp_exponent_models_UserRealmProxyInterface) object).realmGet$first();
        if (realmGet$first != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.firstIndex, rowIndex, realmGet$first, false);
        }
        String realmGet$last = ((host_exp_exponent_models_UserRealmProxyInterface) object).realmGet$last();
        if (realmGet$last != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastIndex, rowIndex, realmGet$last, false);
        }
        String realmGet$email = ((host_exp_exponent_models_UserRealmProxyInterface) object).realmGet$email();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(host.exp.exponent.models.User.class);
        host.exp.exponent.models.User object = null;
        while (objects.hasNext()) {
            object = (host.exp.exponent.models.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, host.exp.exponent.models.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(host.exp.exponent.models.User.class);
    ...
    public static host.exp.exponent.models.User createDetachedCopy(host.exp.exponent.models.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        host.exp.exponent.models.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new host.exp.exponent.models.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (host.exp.exponent.models.User) cachedObject.object;
            }
            unmanagedObject = (host.exp.exponent.models.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        host_exp_exponent_models_UserRealmProxyInterface unmanagedCopy = (host_exp_exponent_models_UserRealmProxyInterface) unmanagedObject;
        host_exp_exponent_models_UserRealmProxyInterface realmSource = (host_exp_exponent_models_UserRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        host_exp_exponent_models_UserRealmProxy aUser = (host_exp_exponent_models_UserRealmProxy)o;
